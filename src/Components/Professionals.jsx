...
const Professionals = () => {
    ...
    const Cards = [
        { name: "Lorem Ipsum Dolor Sit", des: "vhvhvhvhvhvhvhh", image: slide, url: "https://www.linkedin.com/in/vipul-taneja-a71597219/" },
        { name: "vipul", des: "vhvhvhvhvhvhvhh", image: Doctor, url: "https://www.linkedin.com/in/vipul-taneja-a71597219/" },
        { name: "hhhhhhhhhht", des: "vhvhvhvhvhvhvhh", image: Teacher, url: "https://www.linkedin.com/in/vipul-taneja-a71597219/" },
        { name: "Lorem Ipsum Dolor Sit", des: "vhvhvhvhvhvhvhh", image: Engineer, url: "https://www.linkedin.com/in/vipul-taneja-a71597219/" },
        { name: "vipul", des: "vhvhvhvhvhvhvhh", image: Govt, url: "https://www.linkedin.com/in/vipul-taneja-a71597219/" },
        { name: "hhhhhhhhhht", des: "vhvhvhvhvhvhvhh", image: Officers, url: "https://www.linkedin.com/in/vipul-taneja-a71597219/" },
    ];
        ...
        <div className='p-6 px-[4%] lg:px-[8%] w-full relative'>
                ...
                <form class="max-w-2xl mt-4">
                    <div class="flex">
                        ...
                        <div class="relative w-full">
                            <input type="text" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-700 bg-gray-50 rounded-e-lg border-s-gray-2 border-s-2 border border-gray-300 focus:ring-[#0BDBB6] focus:border-[#0BDBB6] dark:border-[#0BDBB6] dark:text-white dark:focus:border-[#0BDBB6]" placeholder="Search cardiologist, doctors..." required value="Search cardiologist, doctors..." onChange="{handleSearchInputChange}" />
                            <button type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium h-full text-white bg-[#0BDBB6] rounded-e-lg border border-[#0BDBB6] hover:bg-[#0BDBB6] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#0BDBB6] dark:hover:bg-[#0BDBB6] dark:focus:ring-blue-800">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 space-x-4 mt-4'>
                <div className='h-96  md:w-[95%] w-full bg-gradient-to-r from-[#2D4760] to-[#275680] rounded-lg relative px-4 p-4 mt-2'>
                    <div>
                        <h1 className='text-4xl font-bold w-[60%] text-white '>{Cards[activeIndex].name} </h1>
                        <h2 className='text-white w-[60%] text-sm'>{Cards[activeIndex].des}</h2>
